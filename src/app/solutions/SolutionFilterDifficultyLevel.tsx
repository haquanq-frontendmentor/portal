          ...
          >
            ...
            <fieldset className="flex flex-col gap-1 font-medium">
              ...
              {Object.values(DIFFICULTY_LEVLES).map((level) => (
                <label
                  className="group relative flex cursor-pointer items-center gap-3 rounded-md p-2 capitalize hover:bg-gray-50 dark:hover:bg-gray-800"
                  key={level + "filter"}
                >
                  <input
                  ...
                  />
                  <span className="flex size-6 items-center justify-center rounded-sm border border-gray-900 transition-colors peer-checked:bg-gray-900 peer-checked:text-white peer-checked:*:opacity-100 dark:border-gray-50 dark:peer-checked:bg-gray-50">
                    <CheckIcon
                      className="text-gray-50 opacity-0 transition-opacity dark:text-gray-900"
                      width={16}
                      height={16}
                    />
                  </span>
                  <span className="">{level}</span>
                  <span className="absolute inset-0 rounded-md peer-focus-visible:outline-2 peer-focus-visible:outline-gray-900 dark:peer-focus-visible:outline-gray-50"></span>
                </label>
              ))}
            </fieldset>
          </Popover.Popup>
